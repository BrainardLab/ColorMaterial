...
theLookupTable = load(['../colorMaterialInterpolateFun' whichInterp whichDistance]);
...
if (DO_INITIALIZE)
    ...
    save(fullfile(tempdir,['initalizedQuestsParamsCheck' whichInterp whichDistance]),'questData','questDataAllTrials');
end
...
load(fullfile(tempdir,['initalizedQuestsParamsCheck' whichInterp whichDistance]),'questDataAllTrials');
