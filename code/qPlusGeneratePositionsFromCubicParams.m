...
function returnTempParams = qPlusGeneratePositionsFromCubicParams(nSets, whichSmoothSpacing)
...
for i  = 1:nSets
    ...
    while notMonotonic
        ...
        tempW = rand(1); % set to a random number between 0 and 1. 
        sigma = 1;
