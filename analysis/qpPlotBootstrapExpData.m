...
cd (analysisDir)
FigureSave(['Figure4:qPlusBestBootstrap'],gcf,'pdf');
...
figure
plot(1, 1,'o', 'MarkerFaceColor',colorsPerSubject(11,:), 'MarkerFaceColor',colorsPerSubject(11,:),  'MarkerSize', thisMarkerSize)
