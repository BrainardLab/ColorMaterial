...
for s = 1:nSubjects
    ...
    load([analysisDir '/' subjectList{s}, 'BootstrapBestParamsFit_New.mat'])
    ...
    cd (analysisDir)
    %FigureSave([subjectListID{s} ' BootstrapDetails_New'],gcf,'pdf');
end
...
%FigureSave('AllSubjectsBootstrapWeights_New',gcf,'pdf');
...
%FigureSave(['AllSubjectsCMRatioVsWeights_New'],gcf,'pdf');
...
cd (analysisDir)
%FigureSave(['Figure5:qPlusBestBootstrap_New'],gcf,'pdf');
...
%FigureSave('SubjectMappingCode_New', gcf, 'pdf')
